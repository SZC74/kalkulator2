  ...
  return (
    <section className="report-item print-page">
      ...
      <div className="report-estimates">
        <article>
          <span>Estymator LeakQ</span>
          <strong>{formatNumber(calculation.qLeakQLMin, 1)} L/min</strong>
          <p>{formatNumber(calculation.annualM3LeakQ, 0)} m³/rok</p>
          <b>{formatNumber(calculation.annualCostLeakQ, 0)} PLN/rok</b>
        </article>
        <article>
          <span>Estymator dB z kamery</span>
          <strong>{formatNumber(calculation.qDbLMin, 1)} L/min</strong>
          <p>{formatNumber(calculation.annualM3Db, 0)} m³/rok</p>
          <b>{formatNumber(calculation.annualCostDb, 0)} PLN/rok</b>
        </article>
      </div>
    ...
    <div className="report-shell">
      <div className="report-toolbar no-print">
        <div>
          ...
          <p>Uwagi są zwykłymi polami projektu, dlatego pozostają po zamknięciu raportu.</p>
        </div>
      ...
      <main className="report-document">
        <section className="report-cover">
          ...
          <div className="report-total-grid">
            <article><span>Łącznie, LeakQ</span><strong>{formatNumber(totals.costLeakQ, 0)} PLN/rok</strong><p>{formatNumber(totals.qLeakQ, 1)} L/min</p></article>
            <article><span>Łącznie, dB</span><strong>{formatNumber(totals.costDb, 0)} PLN/rok</strong><p>{formatNumber(totals.qDb, 1)} L/min</p></article>
          </div>
          ...
          <table className="summary-table">
            <thead><tr><th>ID</th><th>Lokalizacja</th><th>LeakQ</th><th>dB</th><th>Koszt LeakQ</th><th>Koszt dB</th></tr></thead>
